...
export const getWeather = (currentAddress) => async(dispatch) => {
    ...
    const {data} = await axios.get(`https://api.openweathermap.org/data/2.5/forecast?zip=11102&weather?q=${currentAddress}&APPID=6113ff2d6d0ef09bd1a0cc061a15fbfb&units=metric`)
